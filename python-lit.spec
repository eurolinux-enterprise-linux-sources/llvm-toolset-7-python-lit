...
%global py2_install %{expand: CFLAGS="%{optflags}" %{__python2} setup.py %{?py_setup_args} install -O1 --skip-build --root %{buildroot}%{?scl:%_scl_root}}
...
Source0: https://pypi.python.org/packages/57/6f/6084079308473998dc2b9def8c508362f68be2b6dca32b5ff06739479ff1/lit-%{version}.tar.gz
